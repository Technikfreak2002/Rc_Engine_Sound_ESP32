...
const uint8_t escRampTimeFirstGear = 25; // determines, how fast the acceleration and deceleration happens (about 15 - 25, 20 for King Hauler)
...
const uint8_t escBrakeSteps = 75; // determines, how fast the ESC is able to brake down (20 - 30, 30 for King Hauler)
